...
export default function Service() {
    return (
        <div className="w-[70%] m-auto py-[150px]">
            <h1 className="text-center font-bold text-[30px]  py-5">PRIVACY POLICY</h1>
            <div className="px-5">
                <p className="text-start leading-7">
                    This Privacy Policy describes how your personal information is collected, used,
                    and shared when you visit or make a purchase from shop-t1-na.gg (the “Site”).
            ...
            <div className=" px-5 ">
                <h3 className="font-semibold text-xl py-5">Personal information we collect </h3>
                ...
                <p className="text-start leading-7">
                    ...
                    and often include an anonymous unique identifier. For more information abou
                    t cookies, and how to disable cookies, visit http://www.allaboutcookies.org.
                    - “Log files” track actions occurring on the Site, and collect data including
                    ormation about how you browse the Site.
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">How do we use your personal information? </h3>
                <p className="text-start leading-7">
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">Sharing you personal Information </h3>
                <p className="text-start leading-7">
                    ...
                    how Shopify uses your Personal Information here: https://www.shopify.com/legal/privacy.
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">Behavioural advertising  </h3>
                <p className="text-start leading-7">
                    ...
                    (“NAI”) educational page at http://www.networkadvertising.org/understanding-online-advertising/how-does-it-work.
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">Your rights </h3>
                <p className="text-start leading-7">
                    If you are a European resident, you have the right to access personal
                    information we hold about you and to ask that your personal informatio
                    n be corrected, updated, or deleted. If you would like to exercise this
                    ...
                    (for example if you make an order through the Site), or otherwise to pursue our
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">Data retention   </h3>
                <p className="text-start leading-7">
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">Changes
                </h3>
                <p className="text-start leading-7">
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">Contact us   </h3>
                <p className="text-start leading-7">
                    For more information about our privacy practices, if you have questions,
                    or if you would like to make a complaint, please contact us by e‑mail at customerhelp@t1.gg.
