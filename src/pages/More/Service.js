...
export default function Service() {
    return (
        <div className="w-[70%] m-auto py-[150px]">
            <h1 className="text-center font-bold text-[30px]  py-5">TERMS OF SERVICE</h1>


            <div className=" px-5 ">
                <h3 className="font-semibold text-xl py-5">OVERVIEW</h3>

                <p className="text-start leading-7">
                    This website is operated by T1 Entertainment & Sports. Throughout the site, the terms “we”, “us” and “our” refer to T1 Entertainment & Sports. T1 Entertainment & Sports offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 1 - ONLINE STORE TERMS</h3>
                <p className="text-start leading-7">
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 2 - GENERAL CONDITONS</h3>
                <p className="text-start leading-7">
                    ...
                    the Service, or access to the Service or any contact on the website through which the service is provided, without express
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION </h3>
                <p className="text-start leading-7">
                    ...
                    and should not be relied upon or used as the sole basis for making decisions without consulting primary, more accurate, more complete or more timely sources of information. Any reliance on the material on this site is at your own risk.

                    This site may contain certain historical information. Historical information, necessaril
                    y, is not current and is provided for your reference only. We reserve the right to modify the
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES </h3>
                <p className="text-start leading-7">
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 5 - PRODUCTS OR SERVICES (if applicable)  </h3>
                <p className="text-start leading-7">
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION   </h3>
                <p className="text-start leading-7">
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 7 - OPTIONAL TOOLS   </h3>
                <p className="text-start leading-7">
                    We may provide you with access to third-party tools over which we neither monitor nor have any control nor input.

                    You acknowledge and agree that we provide access to such tools ”as is” and “as available” without any warranties, representations or conditions
                    of any kind and without any endorsement. We shall have no liability whatsoever arising from or relating to your use of optional third-party tools.

                    Any use by you of optional tools offered through the site is entirely at your
                    own risk and discretion and you should ensure that you are familiar with and approve of the terms on which tools are provided by the relevant third-party provider(s).
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 8 - THIRD-PARTY LINKS   </h3>
                <p className="text-start leading-7">
                    ...
                    and will not have any liability or responsibility for any third-party materials or websites, or for any other materials,
                    ...
                    policies and practices and make sure you understand them before you engage in any transaction. Complaints, claims, concerns,
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS    </h3>
                <p className="text-start leading-7">
                    ...
                    or otherwise (collectively, 'comments'), you agree that we may, at any time, without restriction, edit, copy,
                    publish, distribute, translate and otherwise use in any medium any comments that you forward to us. We are and shall be
                    ...
                    offensive, threatening, libelous, defamatory, pornographic, obscene or otherwise objectionable or violates any party’s intellectual
                    ...
                    computer virus or other malware that could in any way affect the operation of the Service or any related website.
                    You may not use a false e‑mail address, pretend to be someone other than yourself, or otherwise mislead us or third-parties as
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 10 - PERSONAL INFORMATION    </h3>
                <p className="text-start leading-7">
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS    </h3>
                <p className="text-start leading-7">
            ...
            <div className="px-5">
                ...
                <h3 className="font-semibold text-xl py-5">SECTION 12 - PROHIBITED USES    </h3>
                <p className="text-start leading-7">
                    ...
                    , laws, or local ordinances; (d) to infringe upon or violate our intellectual property rights or the intellectual
                    ...
                    for any obscene or immoral purpose; or (k) to interfere with or circumvent the security features of the Service
